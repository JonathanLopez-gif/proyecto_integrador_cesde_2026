...
import co.edu.cesde.am.application.repository.GroupSubjectRepository;

import java.util.ArrayList;
import java.util.List;

public class GroupSubjectJpaRepository implements GroupSubjectRepository {
    ...
    public GroupSubjectJpaRepository(){
